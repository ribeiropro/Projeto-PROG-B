# 🍃 ORBE - Organização, Bem-estar, Evolução

Atinja sua melhor versão.

O ORBE é uma aplicação de desenvolvimento pessoal e organização, criada para ajudar o usuário a organizar sua rotina, registrar suas atividades e acompanhar sua evolução. A aplicação reúne, em um único lugar, ferramentas para planejamento, estudos, exercícios e hábitos, permitindo que o usuário tenha maior controle sobre seu dia a dia e acompanhe seu progresso ao longo do tempo.
...
Uma das principais características do ORBE será permitir que o usuário não apenas registre suas atividades, mas consiga visualizar sua evolução e observar suas metas cumpridas, acompanhado de um sistema de gamificação, onde o usuário ganha XP por completar atividades e subir de nível.


Assim, o usuário consegue perceber seu progresso ao longo dos dias e semanas.
